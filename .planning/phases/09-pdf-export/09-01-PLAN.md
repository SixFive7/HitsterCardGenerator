...
Handle errors gracefully - return 400 for invalid request, 500 for generation failures.
  ...
  <verify>
curl -X POST http://localhost:5657/api/export -H "Content-Type: application/json" -d '{"cards":[{"trackId":"test","title":"Test","artist":"Artist","year":2020,"genre":"Pop"}],"genreColors":{"Pop":"#FF69B4"},"cuttingLines":"None"}' --output test.pdf && file test.pdf
  </verify>
